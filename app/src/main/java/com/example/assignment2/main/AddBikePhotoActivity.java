...
public class AddBikePhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bike_photo);


        textureView  = findViewById(R.id.addPhotoTextureView);
        takePhotoBtn = findViewById(R.id.addPhotoBtn);
    ...
    private void openCamera() throws CameraAccessException {
        ...
        && ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(AddBikePhotoActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 101);
            return;
        }
